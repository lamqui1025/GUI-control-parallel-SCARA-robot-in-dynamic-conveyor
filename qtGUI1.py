...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(12, 27, 138, 97))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 620, 161, 191))
        ...
        self.lb_vY.setGeometry(QtCore.QRect(72, 79, 83, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lb_vZ.setGeometry(QtCore.QRect(72, 106, 83, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lb_vtheta1.setGeometry(QtCore.QRect(72, 133, 83, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lb_vtheta4.setGeometry(QtCore.QRect(72, 160, 83, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(10, 440, 161, 141))
        self.groupBox_3.setObjectName("groupBox_3")
        self.btnStop_robot = QtWidgets.QPushButton(self.groupBox_3)
        self.btnStop_robot.setGeometry(QtCore.QRect(80, 60, 81, 41))
        self.btnStop_robot.setObjectName("btnStop_robot")
        self.btnStart_robot = QtWidgets.QPushButton(self.groupBox_3)
        self.btnStart_robot.setGeometry(QtCore.QRect(0, 60, 81, 41))
        self.btnStart_robot.setObjectName("btnStart_robot")
        self.btnReset_robot = QtWidgets.QPushButton(self.groupBox_3)
        self.btnReset_robot.setGeometry(QtCore.QRect(0, 20, 161, 41))
        self.btnReset_robot.setObjectName("btnReset_robot")
        self.label = QtWidgets.QLabel(self.groupBox_3)
        self.label.setGeometry(QtCore.QRect(80, 112, 61, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.lbStatus_robot = QtWidgets.QLabel(self.groupBox_3)
        self.lbStatus_robot.setGeometry(QtCore.QRect(10, 110, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lbStatus_robot.setFont(font)
        self.lbStatus_robot.setObjectName("lbStatus_robot")
        ...
        self.btnRun_conveyor.setGeometry(QtCore.QRect(90, 110, 61, 31))
        ...
        self.btnStop_conveyor.setGeometry(QtCore.QRect(70, 140, 81, 31))
        ...
        self.btnTest_robot = QtWidgets.QPushButton(self.centralwidget)
        self.btnTest_robot.setGeometry(QtCore.QRect(240, 510, 101, 51))
        self.btnTest_robot.setObjectName("btnTest_robot")
        self.btnScaleCam = QtWidgets.QPushButton(self.centralwidget)
        self.btnScaleCam.setGeometry(QtCore.QRect(880, 450, 81, 41))
        self.btnScaleCam.setObjectName("btnScaleCam")
        self.btnYolo_work = QtWidgets.QPushButton(self.centralwidget)
        self.btnYolo_work.setGeometry(QtCore.QRect(960, 450, 81, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnStart.setText(_translate("MainWindow", "ON"))
        self.btnStop.setText(_translate("MainWindow", "OFF"))
        ...
        self.lbStatus_robot.setText(_translate("MainWindow", "respond"))
        ...
        self.btnTest_robot.setText(_translate("MainWindow", "Test"))
